...
public class LinearProbeHashMap<K, V> implements Map<K, V> {
	...
	private Pair[] data;
	private int[] sizes = {2, 5, 11, 17, 33, 67, 127, 257, 509, 1031, 2053, 4093, 8191, 16381, 32771, 65537, 131071, 262139, 524287, 1048573, 2097143, 4194301, 8388593, 16777213, 33554393, 67108859, 134217689, 268435399, 536870909, 1073741789, 2147483647}
